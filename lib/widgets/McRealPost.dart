...
import '../screens/mcreal/ImageViewer.dart';
import '../screens/mcreal/McRealPostDetails.dart';
import '../screens/mcreal/ReportMcReal.dart';
import '../utils/McRealStatus.dart';
import '../utils/NoRiskApi.dart';
import '../utils/NoRiskIcon.dart';
import '../utils/ReportTypes.dart';
import 'LoadingIndicator.dart';
import 'NoRiskButton.dart';
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return Platform.isAndroid
            ? AlertDialog(
                title: Text(
                  AppLocalizations.of(context).mcRealDeletePostTitle,
                ),
                content: Text(
